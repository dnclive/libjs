...
const fReplace = (object, fromVal, toVal) => {
  if (object!==null && typeof object === 'object' && !Array.isArray(object)) {
    ...
    for (let i = 0; i < keys.length; i++) {
      ...
      if (val!==null && typeof val === 'object') newObject[key] = fReplace(val, fromVal, toVal)
      else if (val === fromVal) newObject[key] = toVal
      else newObject[key] = val
    }
    return newObject
  } else if (object!==null && typeof object === 'object' && Array.isArray(object)) {
    return object.map(ii=>fReplace(ii, fromVal, toVal))
